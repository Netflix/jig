...
public abstract class XmlService {
     ...
     */
    @Nonnull
    public static XmlNode read(InputStream input, InputLocationBuilder locationBuilder)
     ...
     */
    @Nonnull
    public static XmlNode read(Reader reader, InputLocationBuilder locationBuilder)
            throws XMLStreamException {
     ...
     */
    @Nonnull
    public static XmlNode read(XMLStreamReader reader, InputLocationBuilder locationBuilder)
            throws XMLStreamException {
        return getService().doRead(reader, locationBuilder);
    }
    ...
    private static final class Holder {
        static final XmlService INSTANCE =
                new com.netflix.tools.jig.internal.org.apache.maven.internal.xml.DefaultXmlService();
