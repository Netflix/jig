...
import com.netflix.tools.jig.internal.org.apache.maven.repository.internal.PluginsMetadata.PluginInfo;
                ...
                try (JarFile artifactJar = new JarFile(artifactPath.toFile(), false)) {
                    ...
                    if (pluginDescriptorEntry != null) {
                        try (InputStream is = artifactJar.getInputStream(pluginDescriptorEntry)) {
                            ...
                            // com.netflix.tools.jig.internal.org.apache.maven.plugin.descriptor.PluginDescriptor
