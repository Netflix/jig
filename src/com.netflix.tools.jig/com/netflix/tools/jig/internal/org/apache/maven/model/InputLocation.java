...
public final class InputLocation implements java.io.Serializable, Cloneable, InputLocationTracker {
    ...
    public InputLocation(com.netflix.tools.jig.internal.org.apache.maven.api.model.InputLocation location) {
    ...
    } // -- com.netflix.tools.jig.internal.org.apache.maven.model.InputLocation(int, int)

    public InputLocation(int lineNumber, int columnNumber, InputSource source) {
        this.lineNumber = lineNumber;
        this.columnNumber = columnNumber;
        this.source = source;
    } // -- com.netflix.tools.jig.internal.org.apache.maven.model.InputLocation(int, int, InputSource)
    ...
    public com.netflix.tools.jig.internal.org.apache.maven.api.model.InputLocation toApiLocation() {
        if (locations != null && locations.values().contains(this)) {
            if (locations.size() == 1 && locations.values().iterator().next() == this) {
                return new com.netflix.tools.jig.internal.org.apache.maven.api.model.InputLocation(
                        lineNumber,
                        columnNumber,
