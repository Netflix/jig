 ...
 * under the License.
 */
package com.netflix.tools.jig.internal.org.eclipse.aether.spi.connector.checksum;
...
public interface ChecksumPolicy {
    ...
    enum ChecksumKind {
         ...
         * {@link com.netflix.tools.jig.internal.org.eclipse.aether.spi.connector.transport.GetTask#setChecksum(String, String)}. If no included
         * checksum present, {@link #REMOTE_EXTERNAL} is tried for.
         */
        REMOTE_INCLUDED,

        /**
         * Provided checksums may be provided by {@link com.netflix.tools.jig.internal.org.eclipse.aether.spi.checksums.ProvidedChecksumsSource}
