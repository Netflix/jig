...
import com.netflix.tools.jig.internal.org.apache.maven.api.Language;
...
import com.netflix.tools.jig.internal.org.apache.maven.repository.internal.type.DefaultType;
...
import com.netflix.tools.jig.internal.org.eclipse.aether.artifact.ArtifactProperties;
import com.netflix.tools.jig.internal.org.eclipse.aether.artifact.ArtifactType;
...
import com.netflix.tools.jig.internal.org.eclipse.aether.graph.Exclusion;
...
public class ArtifactDescriptorReaderDelegate {
    public void populateResult(RepositorySystemSession session, ArtifactDescriptorResult result, Model model) {
        ...
        for (com.netflix.tools.jig.internal.org.apache.maven.model.Dependency dependency : model.getDependencies()) {
            result.addDependency(convert(dependency, stereotypes));
        }

        DependencyManagement mgmt = model.getDependencyManagement();
        if (mgmt != null) {
            for (com.netflix.tools.jig.internal.org.apache.maven.model.Dependency dependency : mgmt.getDependencies()) {
    ...
    private Dependency convert(com.netflix.tools.jig.internal.org.apache.maven.model.Dependency dependency, ArtifactTypeRegistry stereotypes) {
        ...
        for (com.netflix.tools.jig.internal.org.apache.maven.model.Exclusion exclusion : dependency.getExclusions()) {
    ...
    private Exclusion convert(com.netflix.tools.jig.internal.org.apache.maven.model.Exclusion exclusion) {
