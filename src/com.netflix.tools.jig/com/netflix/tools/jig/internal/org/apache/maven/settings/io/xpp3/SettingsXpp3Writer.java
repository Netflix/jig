...
import com.netflix.tools.jig.internal.org.codehaus.plexus.util.xml.pull.MXSerializer;
...
public class SettingsXpp3Writer
{
     ...
     *
     * @param identifiableBase a identifiableBase object.
     * @param serializer a serializer object.
     * @param tagName a tagName object.
     * @throws java.io.IOException java.io.IOException if any.
     */
        ...
        throws java.io.IOException
    {
        ...
        if ( mirror.isBlocked() != false )
        {
            serializer.startTag( NAMESPACE, "blocked" ).text( String.valueOf( mirror.isBlocked() ) ).endTag( NAMESPACE, "blocked" );
        }
        ...
        throws java.io.IOException
    {
        ...
        serializer.setPrefix( "", "http://maven.apache.org/SETTINGS/1.2.0" );
        serializer.setPrefix( "xsi", "http://www.w3.org/2001/XMLSchema-instance" );
        serializer.startTag( NAMESPACE, tagName );
        serializer.attribute( "", "xsi:schemaLocation", "http://maven.apache.org/SETTINGS/1.2.0 https://maven.apache.org/xsd/settings-1.2.0.xsd" );
