 ...
 * under the License.
 */
package com.netflix.tools.jig.internal.org.apache.maven.api.xml;
...
public interface XmlNode {
     ...
     */
    @Deprecated(since = "4.0.0", forRemoval = true)
    default XmlNode merge(XmlNode source) {
     ...
     */
    @Deprecated(since = "4.0.0", forRemoval = true)
    default XmlNode merge(XmlNode source, Boolean childMergeOverride) {
    ...
    static XmlNode merge(XmlNode dominant, XmlNode recessive) {
        return XmlService.merge(dominant, recessive, null);
    }


    static XmlNode merge(
            XmlNode dominant, XmlNode recessive, Boolean childMergeOverride) {
