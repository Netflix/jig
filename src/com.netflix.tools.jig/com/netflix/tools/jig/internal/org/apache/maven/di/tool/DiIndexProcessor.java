 ...
 * under the License.
 */
package com.netflix.tools.jig.internal.org.apache.maven.di.tool;
...
import com.netflix.tools.jig.internal.org.apache.maven.api.di.Named;
 ...
 * at {@code META-INF/maven/com.netflix.tools.jig.internal.org.apache.maven.api.di.Inject} containing the fully qualified
 * names of these classes.
 *
 * @since 4.0.0
 */
@SupportedAnnotationTypes("com.netflix.tools.jig.internal.org.apache.maven.api.di.Named")
...
public class DiIndexProcessor extends AbstractProcessor {
     ...
     * The file is created at {@code META-INF/maven/com.netflix.tools.jig.internal.org.apache.maven.api.di.Inject} and contains
    ...
    private void updateFileIfChanged() throws IOException {
        String path = "META-INF/maven/com.netflix.tools.jig.internal.org.apache.maven.api.di.Inject";
