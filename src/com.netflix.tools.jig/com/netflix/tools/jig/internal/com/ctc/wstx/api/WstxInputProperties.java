package com.netflix.tools.jig.internal.com.ctc.wstx.api;

import javax.xml.stream.XMLResolver;

import com.netflix.tools.jig.internal.org.codehaus.stax2.XMLInputFactory2;
...
public final class WstxInputProperties
{
     ...
     */
    public final static String P_NORMALIZE_LFS = "com.netflix.tools.jig.internal.com.ctc.wstx.normalizeLFs";

    //public final static String P_NORMALIZE_ATTR_VALUES = "com.netflix.tools.jig.internal.com.ctc.wstx.normalizeAttrValues";
     ...
     * validity rules.
     */
    public final static String P_VALIDATE_TEXT_CHARS = "com.netflix.tools.jig.internal.com.ctc.wstx.validateTextChars";


    /**
     * Allow all XML 1.1 characters escapes even if input document is described as XML 1.0
     * (in addition to ones allowed in 1.l0).
     *<p>
     * Since this is non-standard option (that is, deviates from XML  specification), it is
     * disabled by default.
     *
     * @since 5.2
     */
    public final static String P_ALLOW_XML11_ESCAPED_CHARS_IN_XML10 = "com.netflix.tools.jig.internal.com.ctc.wstx.allowXml11EscapedCharsInXml10";
    ...
    public final static String P_CACHE_DTDS = "com.netflix.tools.jig.internal.com.ctc.wstx.cacheDTDs";
     ...
     */
    public final static String P_CACHE_DTDS_BY_PUBLIC_ID = "com.netflix.tools.jig.internal.com.ctc.wstx.cacheDTDsByPublicId";
     ...
     * @since 4.1.2
     */
    public final static String P_RETURN_NULL_FOR_DEFAULT_NAMESPACE = "com.netflix.tools.jig.internal.com.ctc.wstx.returnNullForDefaultNamespace";
     ...
     */
    @Deprecated
    public final static String P_SUPPORT_DTDPP = "com.netflix.tools.jig.internal.com.ctc.wstx.supportDTDPP";

    /**
     * Whether the Reader will treat character references as entities while parsing
     * XML documents.
     */
    public static final String P_TREAT_CHAR_REFS_AS_ENTS = "com.netflix.tools.jig.internal.com.ctc.wstx.treatCharRefsAsEnts";
     ...
     */
    public final static String P_INPUT_BUFFER_LENGTH = "com.netflix.tools.jig.internal.com.ctc.wstx.inputBufferLength";
     ...
     */
    public final static String P_MIN_TEXT_SEGMENT = "com.netflix.tools.jig.internal.com.ctc.wstx.minTextSegment";
     ...
     * @since 4.2
     */
    public final static String P_MAX_ATTRIBUTES_PER_ELEMENT = "com.netflix.tools.jig.internal.com.ctc.wstx.maxAttributesPerElement";

    /**
     * Maximum length of of individual attribute values (in characters)
     * @since 4.2
     */
    public final static String P_MAX_ATTRIBUTE_SIZE = "com.netflix.tools.jig.internal.com.ctc.wstx.maxAttributeSize";

    /**
     * Maximum number of child elements for any given element.
     * @since 4.2
     */
    public final static String P_MAX_CHILDREN_PER_ELEMENT = "com.netflix.tools.jig.internal.com.ctc.wstx.maxChildrenPerElement";

    /**
     * Maximum number of all elements in a single document.
     * @since 4.2
     */
    public final static String P_MAX_ELEMENT_COUNT = "com.netflix.tools.jig.internal.com.ctc.wstx.maxElementCount";

    /**
     * Maximum level of nesting of XML elements, starting with root element.
     * @since 4.2
     */
    public final static String P_MAX_ELEMENT_DEPTH = "com.netflix.tools.jig.internal.com.ctc.wstx.maxElementDepth";

    /**
     * Maximum length of input document, in characters.
     * @since 4.2
     */
    public final static String P_MAX_CHARACTERS = "com.netflix.tools.jig.internal.com.ctc.wstx.maxCharacters";

    /**
     * Maximum length of individual text (cdata) segments in input, in characters.
     * @since 4.2
     */
    public final static String P_MAX_TEXT_LENGTH = "com.netflix.tools.jig.internal.com.ctc.wstx.maxTextLength";
     ...
     * @since 4.3
     */
    public final static String P_MAX_ENTITY_COUNT = "com.netflix.tools.jig.internal.com.ctc.wstx.maxEntityCount";
     ...
     * @since 4.3
     */
    public final static String P_MAX_ENTITY_DEPTH = "com.netflix.tools.jig.internal.com.ctc.wstx.maxEntityDepth";
     ...
     * @since 5.4 / 6.4
     */
    public final static String P_MAX_DTD_DEPTH = "com.netflix.tools.jig.internal.com.ctc.wstx.maxDtdDepth";
     ...
     */
    public final static String P_CUSTOM_INTERNAL_ENTITIES = "com.netflix.tools.jig.internal.com.ctc.wstx.customInternalEntities";
     ...
     * resolution.
     */
    public final static String P_DTD_RESOLVER = "com.netflix.tools.jig.internal.com.ctc.wstx.dtdResolver";
     ...
     */
    public final static String P_ENTITY_RESOLVER = "com.netflix.tools.jig.internal.com.ctc.wstx.entityResolver";
     ...
     * entities.
     */
    public final static String P_UNDECLARED_ENTITY_RESOLVER = "com.netflix.tools.jig.internal.com.ctc.wstx.undeclaredEntityResolver";
     ...
     * DTD subset).
     */
    public final static String P_BASE_URL = "com.netflix.tools.jig.internal.com.ctc.wstx.baseURL";
     ...
     * @since 6.6
     */
    public final static String P_ALLOW_SURROGATE_PAIR_ENTITIES = "com.netflix.tools.jig.internal.com.ctc.wstx.allowSurrogatePairEntities";
     ...
     */
    public final static String P_INPUT_PARSING_MODE = "com.netflix.tools.jig.internal.com.ctc.wstx.fragmentMode";
