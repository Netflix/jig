...
public final class WstxOutputProperties
{
     ...
     * @since 4.2.2
     */
    public final static String P_USE_DOUBLE_QUOTES_IN_XML_DECL = "com.netflix.tools.jig.internal.com.ctc.wstx.useDoubleQuotesInXmlDecl";

    /**
     * Whether writer should just automatically convert all calls that
     * would normally produce CDATA to produce (quoted) text.
     */
    public final static String P_OUTPUT_CDATA_AS_TEXT = "com.netflix.tools.jig.internal.com.ctc.wstx.outputCDataAsText";

    /**
     * Whether writer should copy attributes that were initially expanded
     * using default settings ("implicit" attributes) or not.
     */
    public final static String P_COPY_DEFAULT_ATTRS = "com.netflix.tools.jig.internal.com.ctc.wstx.copyDefaultAttrs";
     ...
     */
    public final static String P_ADD_SPACE_AFTER_EMPTY_ELEM = "com.netflix.tools.jig.internal.com.ctc.wstx.addSpaceAfterEmptyElem";
     ...
     * @since 3.2.8
     */
    public final static String P_AUTOMATIC_END_ELEMENTS = "com.netflix.tools.jig.internal.com.ctc.wstx.automaticEndElements";
     ...
     */
    public final static String P_OUTPUT_VALIDATE_STRUCTURE = "com.netflix.tools.jig.internal.com.ctc.wstx.outputValidateStructure";
     ...
     * such constraints are: comment/'--', cdata/{@code ']]>'},
     * proc. instr/{@code '?>'}.
     */
    public final static String P_OUTPUT_VALIDATE_CONTENT = "com.netflix.tools.jig.internal.com.ctc.wstx.outputValidateContent";

    /**
     * Whether output classes should check uniqueness of attribute names,
     * to prevent accidental output of duplicate attributes.
     */
    public final static String P_OUTPUT_VALIDATE_ATTR = "com.netflix.tools.jig.internal.com.ctc.wstx.outputValidateAttr";

    /**
     * Whether output classes should check validity of names, ie that they
     * only contain legal XML identifier characters.
     */
    public final static String P_OUTPUT_VALIDATE_NAMES = "com.netflix.tools.jig.internal.com.ctc.wstx.outputValidateNames";
     ...
     * content with "--", CDATA with {@code "]]>"} and proc. instr data with {@code "?>"}.
     * This can
     ...
     */
    public final static String P_OUTPUT_FIX_CONTENT = "com.netflix.tools.jig.internal.com.ctc.wstx.outputFixContent";
     ...
     */
    public final static String P_OUTPUT_ESCAPE_CR = "com.netflix.tools.jig.internal.com.ctc.wstx.outputEscapeCr";
     ...
     */
    public final static String P_OUTPUT_INVALID_CHAR_HANDLER = "com.netflix.tools.jig.internal.com.ctc.wstx.outputInvalidCharHandler";
     ...
     *
     * If specified {@link com.netflix.tools.jig.internal.org.codehaus.stax2.XMLOutputFactory2#P_AUTOMATIC_EMPTY_ELEMENTS} is ignored.
     */
    public final static String P_OUTPUT_EMPTY_ELEMENT_HANDLER = "com.netflix.tools.jig.internal.com.ctc.wstx.outputEmptyElementHandler";
     ...
     * flushing output.
     */
    public final static String P_OUTPUT_UNDERLYING_STREAM = "com.netflix.tools.jig.internal.com.ctc.wstx.outputUnderlyingStream";
     ...
     * flushing output.
     */
    public final static String P_OUTPUT_UNDERLYING_WRITER = "com.netflix.tools.jig.internal.com.ctc.wstx.outputUnderlyingWriter";
}
